...
export function MessageList({ messages, busy, editingIndex, onEdit }: MessageListProps) {
	...
	return (
		<main className="min-h-0 w-[calc(100%-40px)] max-w-210 justify-self-center overflow-y-auto px-1 pt-8 pb-10 max-[620px]:w-[calc(100%-20px)]" ref={containerRef}>
			{messages.length === 0 && (
				<div className="grid min-h-full place-content-center justify-items-center pb-20 text-center">
